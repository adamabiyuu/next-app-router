    ...
    <div className="grid grid-cols-3 mt-5 place-items-center">
      ...
      {products.data.length > 0 &&
        products.data.map((product: any) => (
          <div key={product.id} className="w-full bg-slate-500 max-w-sm bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs my-5">
            <a href="#">
              <img className="rounded-t-lg p-8 object-cover h-96 w-full mb-6 " src={product.image} alt="product image" />
            </a>
            <div>
              <a href="#">
